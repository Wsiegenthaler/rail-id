...
const Energy = new Field('Energy Supply', 'passenger.energy')
...
export const DC1000          = Energy.value('1000 V DC')
export const DC1500          = Energy.value('1500 V DC')
export const DC3000          = Energy.value('3000 V DC')
export const AllTensions     = Energy.value('All tensions', 'Single phase alternating current 1000 V 51 to 15 Hz, single phase alternating current 1500 V 50 Hz, direct current 1500 V, direct current 3000 V. Can include single phase alternating current 3000 V 50 Hz. For certain vehicles with 1000 V single phase alternating current, only one frequency, either 16 2/3 or 50 Hz, is permitted.')
